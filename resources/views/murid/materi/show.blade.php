  ...
  <div class="bg-white shadow-lg rounded-lg p-6">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
      ...
      <div class="flex flex-col md:flex-row md:space-x-2 space-y-2 md:space-y-0">
        <a href="{{ route('murid.materi.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition">
        ...
        <tbody>
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-4 py-2 border-t">
              <a href="{{ route('murid.materi.download', $item->id) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
          ...
          @empty
          <tr>
            <td colspan="4" class="text-center px-4 py-2 border-t">Tidak ada materi untuk pelajaran ini.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
