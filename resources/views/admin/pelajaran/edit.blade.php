...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
  ...
  <form action="{{ route('pelajaran.update', $pelajaran->id) }}" method="POST" class="space-y-6">
    @csrf
    @method('PUT')
    <div>
        <label for="nama" class="block text-gray-700 font-medium mb-1">Nama Pelajaran</label>
        <input type="text" name="nama" id="nama" value="{{ old('nama', $pelajaran->nama) }}" placeholder="Masukkan nama pelajaran"
      ...
      <div>
        ...
        <input type="text" name="deskripsi" id="deskripsi" value="{{ old('deskripsi', $pelajaran->deskripsi) }}" placeholder="Masukkan deskripsi"
