@extends('layouts.guruapp') {{-- Gunakan layout khusus untuk guru, atau gunakan layouts.adminapp jika belum ada layout khusus --}}
...
<div class="container mx-auto mt-8">
  <div class="bg-white shadow-lg rounded-lg p-6">
    <h2 class="text-2xl font-bold text-gray-800 mb-4">Jadwal Mengajar Saya</h2>
